...
#define ID_CUSWPN 9224467
#define STRN_BASEWPN "weapon_deagle"
#define STRN_CUSWPN "weapon_deagleD"
#define DAMAGE_CUSWPN 82.0
#define CLIP_CUSWPN 28
#define RECOIL_CUSWPN 0.6
#define ACCURACY_CUSWPN 0.5
#define MAXAMMO_CUSWPN 105
...
{
	"models/zombi/supplybox_item/v_ddeagle.mdl",
	"models/zombi/supplybox_item/p_ddeagle.mdl",
	"models/zombi/supplybox_item/w_ddeagle.mdl"
}
...
public load_cfg()
{
	formatex(g_item1_name, charsmax(g_item1_name), "%L", LANG_SERVER, "SUPPLY_ITEM_DDEAGLE")
}
...
public Fw_Ham_Weapon_PrimaryAttack(entity)
{
	...
	set_member(entity, m_Weapon_flNextPrimaryAttack, 0.1)
	...
	EjectBrass(pPlayer, get_member(entity, m_DEAGLE_iShell), 1);
