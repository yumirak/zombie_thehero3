...
public plugin_init()
{
	...
	// RegisterHam(Ham_Weapon_Reload, STRN_BASEWPN, "fw_WeaponReloadPre")
	// RegisterHam(Ham_Item_AddToPlayer, STRN_BASEWPN, "fw_ItemAddToPlayerPost", 1)
	// RegisterHam(Ham_Weapon_WeaponIdle, STRN_BASEWPN, "fw_WeaponWeaponIdle")
	// RegisterHam(Ham_Item_PostFrame,	STRN_BASEWPN, "fw_ItemPostFrame");
