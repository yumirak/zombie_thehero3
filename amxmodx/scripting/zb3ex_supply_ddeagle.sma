...
#define WEAPON_MULTIPLIER_ACCURACY 	0.75
#define WEAPON_MULTIPLIER_RECOIL 	1.0

#define WEAPON_TIME_NEXT_IDLE 		2.00
#define WEAPON_TIME_NEXT_ATTACK 	0.1
#define WEAPON_TIME_DELAY_DEPLOY 	1.10
#define WEAPON_TIME_DELAY_RELOAD 	4.6

// Extra
#define ITEM_NAME			"Dual Nighthawk" 

// Models
#define MODEL_WORLD		"models/zombie_thehero/supplybox_item/w_ddeagle.mdl"
#define MODEL_VIEW		"models/zombie_thehero/supplybox_item/v_ddeagle.mdl"
...
Weapon_OnPrimaryAttack(const iItem, const iPlayer, const iClip, const iAmmoPrimary)
{
	...
	{	
		...
		Weapon_SendAnim(iPlayer, random_num(ANIM_SHOOT_LEFT,ANIM_SHOOT_LEFT5));
	...
	else
	{
		...
		Weapon_SendAnim(iPlayer,  random_num(ANIM_SHOOT_RIGHT,ANIM_SHOOT_RIGHT5));
...
{
	if(hero_type == HERO_ANDREY || HERO_KATE) Weapon_Give(id);
}
